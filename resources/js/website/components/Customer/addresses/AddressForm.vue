<template>
  <div :class="{'p-4': modal === true}">
    <div class="head">
      <h4>{{ modeLabel }} address</h4>
      <span
        v-if="modal"
        class="mdi mdi-close-thick"
        @click="$modal.hide('addressForm')"
      ></span>
    </div>
    <form @submit.prevent="submit" method="POST">
      ...
      <div
        class="form-group"
        :class="{ 'is-invalid': hasError('address_line1') }"
      >
      ...
      <div class="row">
        <div class="col-md-6">
          <div
            class="form-group"
            :class="{ 'is-invalid': hasError('pincode') }"
          >
            <label for="pincode"
      ...
      <div class="form-group">
        <label for="is_default">
          <input type="checkbox" id="is_default" v-model="data.is_default" />
          Default
        </label>
      </div>
      <div class="mt-2" :class="{'text-right': !modal}">
